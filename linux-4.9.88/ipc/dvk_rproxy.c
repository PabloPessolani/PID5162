...
/* src_ptr and dst_ptr must be locked 				*/
/*--------------------------------------------------------------*/
 long notify_rmt2lcl(proxy_hdr_t *usr_h_ptr, proxy_hdr_t *h_ptr, 
...
/*--------------------------------------------------------------*/
 long copyrmt_rqst_rmt2lcl(struct proc *rproxy_ptr, struct proc *rmt_ptr, 
...
/* lcl_ptr and rmt_ptr must be locked 				*/
/*--------------------------------------------------------------*/
 long copylcl_rqst_rmt2lcl(struct proc *rproxy_ptr, struct proc *rmt_ptr, 
		struct proc *lcl_ptr, proxy_hdr_t *h_ptr, proxy_payload_t *usr_pay_ptr)
{
	int ret;
	dc_desc_t *dc_ptr;
...
/* lcl_ptr and rmt_ptr must be locked 				*/
/*--------------------------------------------------------------*/
 long copyin_data_rmt2lcl(struct proc *rproxy_ptr, struct proc *rmt_ptr, 
		struct proc *lcl_ptr, proxy_hdr_t *h_ptr, proxy_payload_t *usr_pay_ptr)
{
	int ret;
...
/* lcl_ptr and rmt_ptr must be locked 				*/
/*--------------------------------------------------------------*/
 long copyin_rqst_rmt2lcl(struct proc *rproxy_ptr, struct proc *rmt_ptr, 
		struct proc *lcl_ptr, proxy_hdr_t *h_ptr, proxy_payload_t *usr_pay_ptr)
{
	int ret;
...
/*--------------------------------------------------------------*/
 long copyout_rqst_rmt2lcl( struct proc *rproxy_ptr, struct proc *rmt_ptr, 
		struct proc *lcl_ptr, proxy_hdr_t *h_ptr, proxy_payload_t *usr_pay_ptr)
{
	int ret;
...
/*--------------------------------------------------------------*/
 long copyout_data_rmt2lcl(struct proc *rproxy_ptr, struct proc *rmt_ptr, 
		struct proc *lcl_ptr, proxy_hdr_t *h_ptr, proxy_payload_t *usr_pay_ptr)
{
	int ret;
