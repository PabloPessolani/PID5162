/****************************************************************/
/*			DVK FUNCTION PROTOTYPES 			*/
/****************************************************************/


int dvk_open(struct inode *inode, struct file *filp);
ssize_t dvk_read(struct file *filp, char __user *buf, size_t count, loff_t *f_pos);
ssize_t dvk_write(struct file *filp, const char __user *buf, size_t count, loff_t *f_pos);
...
//long setaffinity_ptr(pid_t , const struct cpumask *);
