...
static int connect_to_switch(struct daemon_data *pri)
{
	...
	printk(UM_KERN_DEBUG "daemon_user.c:connect_to_switch: pri->control=%d fd=%d\n", pri->control, fd );
	pri->data_addr = sun;
	return fd;
...
{
	struct daemon_data *pri = data;
	printk(UM_KERN_DEBUG "daemon_user.c:daemon_open: fd=%d\n",  pri->fd);
...
int daemon_user_write(int fd, void *buf, int len, struct daemon_data *pri)
{
	...
	printk(UM_KERN_DEBUG "daemon_user.c:daemon_user_write: fd=%d len=%d\n",  fd, len );
