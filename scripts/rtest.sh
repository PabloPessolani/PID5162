...
insmod /usr/src/dvs/dvk-mod/dvk.ko dvk_major=33 dvk_minor=0 dvk_nr_devs=1	
dmesg -c > /usr/src/dvs/dvk-tests/dmesg.txt
lsmod | grep dvk
...
#	cd /home/MoL_Module/mol-module/mol-ipc/proxy
	/usr/src/dvs/dvk-proxies/udp_proxy node$rmt_nodeid $rmt_nodeid >node$rmt_nodeid.txt 2>error$rmt_nodeid.txt &
elif  [ $1 == "U" ]
then 
#	cd /usr/src/dvs/dvk-proxies/
	/usr/src/dvs/dvk-proxies/udt_proxy node$rmt_nodeid $rmt_nodeid >node$rmt_nodeid.txt 2>error$rmt_nodeid.txt &
elif  [ $1 == "t" ]
then 
#    	PARA DESHABILITAR EL ALGORITMO DE NAGLE!! 
	echo 1 > /proc/sys/net/ipv4/tcp_low_latency
#	cd /usr/src/dvs/dvk-proxies/
	/usr/src/dvs/dvk-proxies/tcp_proxy node$rmt_nodeid $rmt_nodeid >node$rmt_nodeid.txt 2>error$rmt_nodeid.txt &
elif  [ $1 == "h" ]
then 
#    	PARA DESHABILITAR EL ALGORITMO DE NAGLE!! 
	echo 1 > /proc/sys/net/ipv4/tcp_low_latency
#	cd /usr/src/dvs/dvk-proxies/
	/usr/src/dvs/dvk-proxies/tcp_th_proxy node$rmt_nodeid $rmt_nodeid  >node$rmt_nodeid.txt 2>error$rmt_nodeid.txt &
elif  [ $1 == "z" ]
then 
#    	PARA DESHABILITAR EL ALGORITMO DE NAGLE!! 
	echo 1 > /proc/sys/net/ipv4/tcp_low_latency
#	cd /usr/src/dvs/dvk-proxies/
	/usr/src/dvs/dvk-proxies/lz4tcp_th_proxy node$rmt_nodeid $rmt_nodeid  >node$rmt_nodeid.txt 2>error$rmt_nodeid.txt &
elif  [ $1 == "S" ]
then 
#    	PARA DESHABILITAR EL ALGORITMO DE NAGLE!! 
	echo 1 > /proc/sys/net/ipv4/tcp_low_latency
#	cd /usr/src/dvs/dvk-proxies/
	/usr/src/dvs/dvk-proxies/svr_proxy node$rmt_nodeid $rmt_nodeid  >node$rmt_nodeid.txt 2>error$rmt_nodeid.txt &
elif  [ $1 == "C" ]
then 
#    	PARA DESHABILITAR EL ALGORITMO DE NAGLE!! 
	echo 1 > /proc/sys/net/ipv4/tcp_low_latency
#	cd /usr/src/dvs/dvk-proxies/
	/usr/src/dvs/dvk-proxies/clt_proxy node$rmt_nodeid $rmt_nodeid  >node$rmt_nodeid.txt 2>error$rmt_nodeid.txt &
elif  [ $1 == "s" ]
then 
#    	PARA DESHABILITAR EL ALGORITMO DE NAGLE!! 
	echo 1 > /proc/sys/net/ipv4/tcp_low_latency
...
#  TIPC PROXIES
	tipc-config -net=4711 -a=1.1.10$lcl_nodeid -be=eth:eth0
#	cd /usr/src/dvs/dvk-proxies/
	/usr/src/dvs/dvk-proxies/tipc_proxy node$rmt_nodeid $rmt_nodeid >node$rmt_nodeid.txt 2>error$rmt_nodeid.txt &
fi
...
/usr/src/dvs/dvk-tests/test_add_node 0 $rmt_nodeid
exit
