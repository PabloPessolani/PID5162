...
static 	message m;
	...
	rmt_nodeid 	= pm_m_in.M7_NODEID;
	rmt_ep		= pm_m_in.M7_ENDPT1; 
	bind_type   = pm_m_in.M7_BIND_TYPE;
	arg_v  		= (char **) pm_m_in.M7_ARGV_PTR;
	arg_len   	= pm_m_in.M7_LEN;
