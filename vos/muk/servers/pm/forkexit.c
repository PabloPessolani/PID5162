...
int pm_pm_exit(void)
{
/* Perform the pthread_exit(status) system call. The real work is done by pm_exit(),
 ...
 * exit_status;		 the process' pthread_exit status (for parent) 		     *
 *===========================================================================*/
...
void cleanup(mproc_t *child)
{
	/* Finish off the pthread_exit of a process.  The process has exited or been killed
