...
/* Handle sys_times().  Retrieve the accounting information. */
   ...
   */
	...
	/*open the /proc_table/PID/stat file */
	sprintf(filename, "/proc_table/%d/stat", getpid());
	...
	MUKDEBUG("ppid=%d, pgrp=%d, session=%d, tty=%d, tpgid=%d\n",PS.ppid, PS.pgrp, PS.session, PS.tty, PS.tpgid);
	MUKDEBUG("utime=%d stime=%d\n", PS.utime,PS.stime);
	MUKDEBUG("priority=%d, nice=%d \n",PS.priority, PS.nice);
...
// Reads /proc_table/*/stat files, being careful not to trip over processes with
