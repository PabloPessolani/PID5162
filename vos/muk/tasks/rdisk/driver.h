...
struct driver {
  ...
  _PROTOTYPE( int (*dr_open), (struct driver *dp, message *rd_mptr) );
  _PROTOTYPE( int (*dr_close), (struct driver *dp, message *rd_mptr) );
  _PROTOTYPE( int (*dr_ioctl), (struct driver *dp, message *rd_mptr) );
  ...
  _PROTOTYPE( void (*dr_signal), (struct driver *dp, message *rd_mptr) );
  _PROTOTYPE( void (*dr_alarm), (struct driver *dp, message *rd_mptr) );
  _PROTOTYPE( int (*dr_cancel), (struct driver *dp, message *rd_mptr) );
  _PROTOTYPE( int (*dr_select), (struct driver *dp, message *rd_mptr) );
  _PROTOTYPE( int (*dr_other), (struct driver *dp, message *rd_mptr) );
  _PROTOTYPE( int (*dr_hw_int), (struct driver *dp, message *rd_mptr) );
  _PROTOTYPE( int (*dr_dump), (struct driver *dp, message *rd_mptr) );
...
//_PROTOTYPE( int do_nop, (struct driver *dp, message *rd_mptr) );
// _PROTOTYPE( struct device *nop_prepare, (int device) );
_PROTOTYPE( void nop_cleanup, (void) );
// _PROTOTYPE( void nop_task, (void) );
// _PROTOTYPE( void nop_signal, (struct driver *dp, message *rd_mptr) );
// _PROTOTYPE( void nop_alarm, (struct driver *dp, message *rd_mptr) );
// _PROTOTYPE( int nop_cancel, (struct driver *dp, message *rd_mptr) );
// _PROTOTYPE( int nop_select, (struct driver *dp, message *rd_mptr) );
// _PROTOTYPE( int do_diocntl, (struct driver *dp, message *rd_mptr) );
