...
void extpartition(struct driver *dp, int extdev,unsigned long extbase);
int get_part_table(struct driver *dp, int device,unsigned long offset, struct part_entry *table);
void sort(struct part_entry *table);
 ...
 *				extpartition				      *
 *============================================================================*/
void extpartition(dp, extdev, extbase)
struct driver *dp;	/* device dependent entry points */
 ...
 *				get_part_table				      *
 *============================================================================*/
int get_part_table(dp, device, offset, table)
struct driver *dp;
int device;
