...
#define mol_getkinfo(ptr) 	getsysinfo(pm_ep, SI_KINFO, ptr)
#define mol_getmachine(ptr) 	getsysinfo(pm_ep, SI_MACHINE, ptr)
#define mol_getkproctab(ptr) 	getsysinfo(pm_ep, SI_KPROC_TAB, ptr)
#define mol_getpmproctab(ptr) getsysinfo(pm_ep, SI_PMPROC_TAB, ptr)
#define mol_getprivtab(ptr)   getsysinfo(pm_ep, SI_PRIV_TAB, ptr)
#define mol_getslotstab(ptr)   getsysinfo(pm_ep, SI_SLOTS_TAB, ptr)
